      ...
      <div className="w-screen h-20 z-20 fixed bg-gray-900 text-white">
        <div className="px-3 flex items-center justify-between w-full h-full">
          <div className="flex items-center">
            <Link onClick={() => setNavigation(false)} to="home" smooth duration={500}>
            <h1 className="text-4xl font-bold cursor-pointer hover:text-lightColor duration-200">Afrotechie</h1>
            </Link>
          </div>
